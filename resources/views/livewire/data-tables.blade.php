        ...
        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg mt-4">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <th
                                ...
                                <div class="flex items-center">
                                    <button
                                        ...
                                        class="bg-gray-50 focus:outline-none text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                        Name
                                    </button>
                                    <x-sort-icon
                                        field="name"
                    ...
                    <tbody wire:loading.class="bg-gray-50 transition duration-500 ease-in-out" class="bg-white divide-y divide-gray-200">
